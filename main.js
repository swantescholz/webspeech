...
lowercase (alfa|alpha)=a
lowercase bravo=b
lowercase charlie=c
lowercase delta=d
lowercase echo=e
lowercase (foxtrot|fox trot)=f
lowercase golf=g
lowercase hotel=h
lowercase india=i
lowercase (juliet|juliett)=j
lowercase kilo=k
lowercase lima=l
lowercase mike=m
lowercase november=n
lowercase oscar=o
lowercase papa=p
lowercase (quebec|kebec)=q
lowercase romeo=r
lowercase sierra=s
lowercase tango=t
lowercase uniform=u
lowercase (victor|viktor)=v
lowercase (whiskey|whisky)=w
lowercase (x-ray|xray|x ray)=x
lowercase yankee=y
lowercase zulu=z
